...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 99.0, 190.0, 96.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 431.500000000000114, 153.0, 66.0, 22.0 ],
					"text" : "print error_1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 7,
					"outlettype" : [ "", "", "", "", "", "", "" ],
					"patching_rect" : [ 99.0, 98.0, 351.500000000000114, 22.0 ],
					"text" : "route noteTrigger envAtt envDec envSus envRel chanIndex"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 99.0, 153.0, 240.666666666666742, 22.0 ],
					"text" : "adsr~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 45.0, 236.0, 29.5, 22.0 ],
					"text" : "*~ 1."
				}

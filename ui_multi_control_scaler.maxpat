...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 86.476192494233487, 260.392855823040009, 29.5, 22.0 ],
					"text" : "t b f"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 18.0, 296.214284062385559, 97.976192494233487, 22.0 ],
					"text" : "* 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 84.476192494233487, 197.121177464790435, 46.0, 22.0 ],
					"text" : "route 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 86.476192494233487, 227.478320032425017, 19.0, 22.0 ],
					"text" : "1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 111.476192494233487, 227.478320032425017, 25.0, 22.0 ],
					"text" : "10."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "float" ],
					"patching_rect" : [ 51.047621150811551, 98.0, 29.5, 22.0 ],
					"text" : "t b f"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 18.011907180150388, 140.642856955528259, 62.535713970661163, 22.0 ],
					"text" : "+ 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 18.011906413576696, 18.99999854772949, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 84.476192494233487, 18.99999854772949, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 51.047621150811551, 18.99999854772949, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 18.0, 332.214261547729507, 30.0, 30.0 ]
				}
